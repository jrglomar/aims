    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">View {{ Str::singular($page_title) }}</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea disabled class="form-control" id="remarks_edit" name="remarks_edit" placeholder="Remarks" tabindex="2" rows="5"></textarea>
                            </div>
                        </div>
                    </div>
                </form>
