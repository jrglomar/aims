            ...
            <div class="modal-body">
                <form id="editForm" data-parsley-validate>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label class="required-input">Source</label>
                                <select class="form-control" id="source_id_edit" name="source_id_edit">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label class="required-input">Condition</label>
                                <select class="form-control" id="condition_id_edit" name="condition_id_edit">
